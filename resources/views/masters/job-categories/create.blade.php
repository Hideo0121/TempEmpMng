        ...
        <form method="POST" action="{{ route('masters.job-categories.store') }}" class="space-y-6">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <label class="flex items-center gap-2 text-sm font-semibold text-slate-700">
                            <input type="checkbox" name="is_public" value="1" class="h-4 w-4 rounded border-slate-300 text-blue-600 focus:ring-blue-200" {{ old('is_public', 1) ? 'checked' : '' }}>
                            公開ページに表示する
                        </label>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div>
                    ...
                    <input type="number" id="planned_hires" name="planned_hires" value="{{ old('planned_hires', 0) }}" min="0" max="65535"
                        class="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2 text-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200">
                ...
                <div>
                    ...
                    <textarea id="recruitment_comment" name="recruitment_comment" rows="3" maxlength="1000"
                        class="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2 text-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200"
                        placeholder="例）未経験可／曜日相談可など">{{ old('recruitment_comment') }}</textarea>
